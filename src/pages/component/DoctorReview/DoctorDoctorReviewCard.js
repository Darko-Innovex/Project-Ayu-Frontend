import "../../../css/component/DoctorReview/DoctorDoctorReviewCard.css";

const DoctorDoctorReviewCard = ({ data }) => {
  // data.starCount = 4;
  return (
    <div id="DoctorDoctorReviewCard">
      <div className="title">
        <div className="stars">{returnStarCount(4)}</div>
        <h2>16 / 05 / 2024 | 12 : 00</h2>
      </div>
      <p>
...
const returnStarCount = (starCount) => {
  const star = (
    <svg
...
export default DoctorDoctorReviewCard;
