import "../../../css/component/HospitalPatientManagement/HospitalPatientManagementFilter.css";

const HospitalPatientManagementFilter = ({ closeFilter }) => {
  return (
    <div>
      <div>
        <div className="background">
          <div id="PatientManageFilter">
...
export default HospitalPatientManagementFilter;
