import "../../../../css/component/medicalReport/BackButton.css";

const AddReportBackButton = ({ buttonOnAction }) => {
  return (
    <div>
      <button id="BackButton" onClick={buttonOnAction}>
        <svg
...
export default AddReportBackButton;
