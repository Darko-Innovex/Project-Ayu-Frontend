...
const HealthCardManagementPage = () => {
  const navigate = useNavigate(null);
  const [Filter, setFilter] = useState(false);
  const [addHealthcard, setHealthcard] = useState(false);
  ...
  const handleHealthCard = () => {
    setHealthcard(!addHealthcard);
  };

  // const handleViewHealthCard = (healthcardData) => {
  //   setHealthCardData(healthcardData);
  //   setViewHealthCard(!viewHealthcard);
  // };

  // const handleCancelHealthCard = (healthCardData) => {
  //   setHealthCardData(healthCardData);
  //   setCancelHealthCard(!cancelHealthCard);
  // };

  let data = {
    IndexId: 1234123412341234,
    IndexNumber: 1234123412341234,
    Status: "Pending",
    Date: "2024/05/10",
    Time: "10:20",
  };
  ...
  return (
    <div>
      <div id="PatientDashboard">
        ...
        {Filter && <SearchFilter closeFilter={handleFilter()} />}
        ...
        <div className="PatientAppointmentContend">
          <h1 className="title">Health Card Management</h1>
          <div>
            <div>
              <svg
            ...
            <button onClick={handleHealthCard}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="27"
                height="27"
          ...
          <div className="tableHead">
            <input type="checkbox" />
            <h1 className="indexId">Index Id</h1>
            <h1 className="indexNo">Index No</h1>
            <h1 className="appointmentStatus">Status</h1>
            <h1 className="appointmentDate">Date</h1>
  ...
  if (dataSet) {
    for (let i = 0; i < dataSet.length; i++) {
      RowSet.push(
        <div>
          <input type="checkbox" />
          <h1 className="indexId">{dataSet[i].IndexId}</h1>
          <h1 className="indexNo">{dataSet[i].IndexNumber}</h1>
          <h1
            style={StatusColor(dataSet[i].Status)}
            className="appointmentStatus"
          >
            {dataSet[i].Status}
          </h1>
          <h1 className="appointmentDate">{dataSet[i].Date}</h1>
...
export default HealthCardManagementPage;
